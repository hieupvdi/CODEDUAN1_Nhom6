...
namespace _1.DAL.Extensions
{
    public static class AddData
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
          ...
          new NhanVien() { Id = Guid.Parse("16819dd5-fbe9-404e-8940-0f2816ec533c"), IdCV =Guid.Parse ("e26fa84e-3019-4a14-862f-9fafc6014dfe"), MaNV = "NV1",TenNV="Lê Minh Thanh",LinkAnh= @"C:\Users\hieup\OneDrive\Máy tính\DU_AN_1\icon\c2437ba9152ab9a7_ec2594949c8901fa_9972415113439532143215.jpg", GioiTinh="Nam",NgaySinh=DateTime.Now,Email= "hieuphamvan.dev.it@gmail.com", SDT = "0337019932", DiaChi = "Thanh Hóa",MatKhau="123",Trangthai=1}
